...
gsutil -m rsync -r image_data/na/portrait/corrected_data gs://mirubot/padimages/na/portrait/
gsutil -m rsync -r image_data/jp/portrait/corrected_data gs://mirubot/padimages/jp/portrait/
